# TRẠM NỤ CƯỜI — PHASE 9 PRODUCTION PROTECTION HANDOFF
...
Wait for explicit Owner approval naming the selected Journey before any transition to `registration_open`. Keep email and Turnstile disabled unless separately approved.
